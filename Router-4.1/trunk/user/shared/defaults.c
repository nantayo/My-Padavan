...
struct nvram_pair router_defaults[] = {
	...
	{ "wan_pppoe_username", "110134659021@net" },		/* PPP username */
	{ "wan_pppoe_passwd", "12345678" },		/* PPP password */
	...
	{ "wl_gmode", "3" },			/* A/N/AC Mixed */
#else
	{ "wl_gmode", "2" },			/* A/N Mixed */
#endif
	{ "wl_mcs_mode", "0" },
	{ "wl_channel", "48" },			/* Channel number */
	{ "wl_bcn", "20" },			/* Beacon interval */
	...
	{ "wl_wpa_gtk_rekey", "600" },		/* GTK rotation interval */
